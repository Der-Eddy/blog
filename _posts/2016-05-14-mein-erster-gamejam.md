...
{% include image.html url="gamemaker.png" description="Screenshot aus Gamemaker: Studio" %}
...
{% include image.html url="menu.png" description="Screenshot vom Menu" %}
...
{% include video.html youtube-id="QLiDiahcd64" thumbnail="youtube-thumbnail.jpg" %}

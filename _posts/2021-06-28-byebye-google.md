...
{% include image.html url="firewall.jpg" description="Bei normalem Android wäre so etwas nur über lokale VPN Lösungen wie [Blokada](https://blokada.org/) möglich" %}
